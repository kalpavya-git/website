      ...
      <div className="container mx-auto px-4 py-16">
          ...
          <div>
            ...
            <ul className="space-y-3 font-sans text-sm">
              <li className="flex items-center gap-3 opacity-80">
                ...
                <span>A Block, Pocket - A, Sector -4, Noida -201301</span>
              </li>
              <li className="flex items-center gap-3 opacity-80">
        ...
        <div className="border-t border-primary-foreground/20 mt-12 pt-8 text-center">
          <p className="font-sans text-sm opacity-60">
            ...
            Built by the folks at <a href="https://kalpavyaayurveda.com" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Kalpavya Ayurveda</a>
          </p>
        </div>
      </div>
    </footer>
